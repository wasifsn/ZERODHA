...
async function scraper() {
	try {
		const nseUrl = 'https://www1.nseindia.com/companytracker/cmtracker.jsp?symbol=INFY&cName=cmtracker_nsedef.css';
		...
		let data = await page.evaluate(() => {
			...
			let raw_tables = Array.from(document.querySelectorAll('tr:nth-of-type(5)  tr:nth-of-type(2) div table'));
